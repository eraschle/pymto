...
# IronPython 2.7 compatibility - no typing module
if sys.version_info[0] >= 3:
    ...
    # Define type aliases for IronPython
    List = list
    Dict = dict
    Any = object
    Optional = object
...
class ElementData(object):
    ...
    def from_dict(cls, element_dict):
        ...
        return cls(
            element_dict["object_type"],
            element_dict["layer_name"],
            dimensions,
            points
        )
...
class RevitDataReader(object):
    ...
    def load_data(self):
        ...
        try:
            ...
            raise Exception("Failed to load JSON data: {}".format(str(e)))
    ...
    def get_unique_object_types(self):
        ...
        all_elements = self.get_all_elements()
        return list(set(elem.object_type for elem in all_elements))
    
    def get_unique_layer_names(self):
        """Get all unique layer names in the data"""
        all_elements = self.get_all_elements()
        return list(set(elem.layer_name for elem in all_elements))
